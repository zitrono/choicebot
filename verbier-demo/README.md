<a href="https://chat.vercel.ai/">
  <img alt="Verbier Festival Concierge - AI-powered classical music experience planner" src="app/(chat)/opengraph-image.png">
  <h1 align="center">Verbier Festival Concierge</h1>
</a>

<p align="center">
  Your Personal Festival Concierge for the Verbier Festival - Creating Customized Classical Music Experiences in the Swiss Alps.
</p>
...
This template ships with Google Gemini `gemini-2.5-flash-preview-05-20` model as the default. However, with the [AI SDK](https://sdk.vercel.ai/docs), you can switch LLM providers to [OpenAI](https://openai.com), [Anthropic](https://anthropic.com), [Cohere](https://cohere.com/), and [many more](https://sdk.vercel.ai/providers/ai-sdk-providers) with just a few lines of code.
